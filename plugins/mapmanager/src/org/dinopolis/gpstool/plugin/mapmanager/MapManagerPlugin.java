...
public class MapManagerPlugin implements GuiPlugin, ListSelectionListener
{
	...
	// keys for resources:
	public static final String KEY_MAPMANAGER_PLUGIN_IDENTIFIER =
		"mapmanager.plugin.identifier";
	public static final String KEY_MAPMANAGER_PLUGIN_VERSION =
		"mapmanager.plugin.version";
	public static final String KEY_MAPMANAGER_PLUGIN_NAME =
		"mapmanager.plugin.name";
	public static final String KEY_MAPMANAGER_PLUGIN_DESCRIPTION =
		"mapmanager.plugin.description";
	public static final String KEY_MAPMANAGER_WINDOW_REMEMBER_SETTINGS =
		"mapmanager.window.remember_settings";
	public static final String KEY_MAPMANAGER_WINDOW_DIMENSION_WIDTH =
		"mapmanager.window.dimension.width";
	public static final String KEY_MAPMANAGER_WINDOW_DIMENSION_HEIGHT =
		"mapmanager.window.dimension.height";
	public static final String KEY_MAPMANAGER_WINDOW_LOCATION_X =
		"mapmanager.window.location.x";
	public static final String KEY_MAPMANAGER_WINDOW_LOCATION_Y =
		"mapmanager.window.location.y";
	public static final String KEY_MAPMANAGER_TABLE_COLUMN_NAMES =
		"mapmanager.table.column_names";
	...
	void loadResources()
	{
		...
		catch (MissingResourceException mre)
		{
			...
			System.err.println(
				"MapManagerPlugin: resource file '"
					+ RESOURCE_BUNDLE_NAME
					+ "' not found");
			System.err.println(
	...
	protected void updateWindowLocation()
	{
		try
		{
			main_frame_.setLocation(
				resources_.getInt(KEY_MAPMANAGER_WINDOW_LOCATION_X),
				resources_.getInt(KEY_MAPMANAGER_WINDOW_LOCATION_Y));
			main_frame_.setSize(
				resources_.getInt(KEY_MAPMANAGER_WINDOW_DIMENSION_WIDTH),
	...
	public void valueChanged(ListSelectionEvent event)
	{
		...
		Set selected_map_infos = new TreeSet();
		for (int sel_row_index = 0;
			sel_row_index < selected_rows.length;
			sel_row_index++)
		{
			selected_map_infos.add(
				table_model.getMapInfo(selected_rows[sel_row_index]).getFilename());
		}
		layer_.setSelectedMaps(selected_map_infos);
		layer_.repaint();
	}
	...
	class MapManagerFrameAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			if (main_frame_ == null)
			{
				...
				main_frame_.initialize(
					map_manager_,
					application_resources_,
					resources_);
