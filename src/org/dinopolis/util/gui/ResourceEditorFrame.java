...
implements ActionListener, PropertyChangeListener
{
  ...
  private final static String KEY_OK_BUTTON = "resource_editor.button.ok";

  /** the ok command name */
  private final static String OK_COMMAND = "ok";
  
  /** the key for the cancle button resource */
  private final static String KEY_CANCEL_BUTTON = "resource_editor.button.cancel";

  /** the cancel command name */
  private final static String CANCEL_COMMAND = "cancel";

  /** the title key for the title property */
  private final static String KEY_TITLE = "resource_editor.frame_title";

  /** the key for the width of the frame */
  private final static String KEY_WINDOW_DIMENSION_WIDTH = "resource_editor.dimension.width";

  /** the key for the height of the frame */
  private final static String KEY_WINDOW_DIMENSION_HEIGHT = "resource_editor.dimension.height";

  /** the key for the x location of the frame */
  private final static String KEY_WINDOW_LOCATION_X = "resource_editor.location.x";

  /** the key for the y location of the frame */
  private final static String KEY_WINDOW_LOCATION_Y = "resource_editor.location.y";
 ...
 */
  ...
  public ResourceEditorFrame(Resources resources, String resource_dir)
 ...
 */
    ...
    throws MissingResourceException
  {
    ...
    UIManager.addPropertyChangeListener(this); // get change of l&f events
    ...
    updateLocation();
    updateSize();
    reset(); // initialize all editors/values 
  }
 ...
 */
  ...
  public void setVisible(boolean visible)
  {
    if (isVisible() != visible)
    {
      ...
      super.setVisible(visible);
      if (stored_location_ != null)
        setLocation(stored_location_);
      return;
    }
    super.setVisible(visible);
  }
 ...
 */
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      if (args.length <= 0)
      {
        edit_resources = ResourceManager.getResources(ResourceEditorFrame.class,
                                                      ResourceEditorPanel.RESOURCE_BOUNDLE_NAME, 
                                                      ResourceEditorPanel.RESOURCE_DIR_NAME, 
                                                      Locale.getDefault());
      }
      else
      {
        edit_resources = ResourceManager.getResources(Class.forName(args[0]),
                                                      args[1],
                                                      args[2],
                                                      Locale.getDefault());
      }
