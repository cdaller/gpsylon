...
// ----------------------------------------------------------------------
/**
 * This plugin allows to manage the available maps. It shows all available maps on a layer it
 * provides, it provides a table that lists all available maps and allows to edit them, and it
 * provides a mouse mode, that lets the user interact with the map manager by clicking on the map
 * component.
 * 
...
public class MapManagerPlugin implements GuiPlugin, ListSelectionListener
{
  ...
  /** the mouse mode */
  protected MapManagerMouseMode mouse_mode_;
  ...
  // ----------------------------------------------------------------------
  /**
   * The application calls this method to indicate that the plugin is activated and will be used
   * from now on. The Plugin should initialize any needed resources (files, etc.) in this method.
   * 
   * @throws Exception if an error occurs. If this method throws an exception, the plugin will not
  ...
  // ----------------------------------------------------------------------
  /**
   * The application calls this method to indicate that the plugin is deactivated and will not be
   * used any more. The Plugin should release all resources (close files, etc.) in this method.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns the unique id of the plugin. The id is used to identify the plugin and to distinguish
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns the version of the plugin. The version may be used to choose between different version
   * of the same plugin.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns the name of the Plugin. The name should be a human readable and understandable name
   * like "Save Image as JPEG". It is prefereable but not necessary that the name is localized.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns a description of the Plugin. The description should be human readable and
   * understandable like "This plugin saves the content of the main window as an image in jpeg
   * format". It is prefereable but not necessary that the description is localized.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * The plugin may return a JMenu object to be used in the main menu of the application and may
   * (should) contain other menu items. The menuitems returned should provide an icon, a mnemonic
   * key, and a localized name (and a accelerator key).
   * 
   * @return A menu that is used in the main menu in the application or <code>null</code>, if no
   *         main menu is needed.
   * 
   */
  ...
  // ----------------------------------------------------------------------
  /**
   * The application provides a sub menu for every plugin that may be used. The JMenuItem (or JMenu)
   * returned is added to a submenu in the "plugins" menu item. The menuitems returned should
   * provide an icon, a mnemonic key, and a localized name (and a accelerator key).
   * 
   * @return A menuitem (or a JMenu) that are used in a sub menu in the application or
  ...
  public JMenuItem getSubMenu()
  {
    ...
    {
      frame_menu_item_ = (JMenuItem) MenuFactory.createMenuComponent(MenuFactory.KEY_MENUE_PREFIX, KEY_MAPMANAGER_MENU_NAME, resources_, action_store_);
    }
  ...
  // ----------------------------------------------------------------------
  /**
   * Every plugin may provide one or more mouse modes. These mouse modes may react on mouse clicks,
   * drags, etc.
   * 
   * @return mouse modes that are used by this plugin in the application or <code>null</code>, if
   *         no mouse modes are used.
   * 
   */
  ...
  // ----------------------------------------------------------------------
  /**
   * If the plugin wants to draw anything on the map it may return a layer here or <code>null</code>
   * if not.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * Called by the application to switch the layer on or off. If the layer is switched off, it must
   * not paint anything and should not consume any calculational power.
   * 
   * @param active if <code>true</code> the layer is switched on and should react on changes of
   *          the projection and draw anything in the paintComponent method.
   */
   ...
   * 
   * @return <code>true</code> if the plugin is active and paints something.
   */
  ...
  void loadResources()
  {
    try
    {
      resources_ = ResourceManager.getResources(MapManagerPlugin.class, RESOURCE_BUNDLE_NAME, USER_RESOURCE_DIR_NAME, Locale.getDefault());
    }
  ...
  protected void updateWindowLocation()
  {
    try
    {
      main_frame_.setLocation(resources_.getInt(KEY_MAPMANAGER_WINDOW_LOCATION_X), resources_.getInt(KEY_MAPMANAGER_WINDOW_LOCATION_Y));
      main_frame_.setSize(resources_.getInt(KEY_MAPMANAGER_WINDOW_DIMENSION_WIDTH), resources_.getInt(KEY_MAPMANAGER_WINDOW_DIMENSION_HEIGHT));
    }
  ...
  /**
   * Sets the selected map(s) in the table.
   * @param map_infos the map infos to show.
   */
  ...
  /**
   * Adds a map selection in the table.
   * @param map_infos the map infos to add.
   */
