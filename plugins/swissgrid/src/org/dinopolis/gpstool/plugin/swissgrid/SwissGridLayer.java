...
public class SwissGridLayer extends BasicLayer
{
 ...
 */
  public void paintComponent(Graphics g)
  {
    ...
    double pixel_per_meter_ = getProjection().getScale() / SwissProjection.PIXELFACT;
    ...
    pnw = getProjection().forward(SwissProjection.lv032ll(300000,480000));
    pne = getProjection().forward(SwissProjection.lv032ll(300000,850000));
    psw = getProjection().forward(SwissProjection.lv032ll(65000,480000));
    pse = getProjection().forward(SwissProjection.lv032ll(65000,850000));
