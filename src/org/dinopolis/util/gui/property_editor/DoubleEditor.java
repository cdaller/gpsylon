 ...
 *
 * @author Christof Dallermassl (copied from Dieter Freismuth :-)
 * @version $Revision$
 */
...
{
  private NumberFormat double_formatter_;
  
  public DoubleField()
  {
    super();
    double_formatter_ = NumberFormat.getNumberInstance();
    double_formatter_.setParseIntegerOnly(false);
  }
  ...
  public double getValue() 
  {
    ...
    try 
    {
      ret_val = double_formatter_.parse(getText()).doubleValue();
    } 
  ...
  {
    setText(double_formatter_.format(value));
  }
  ...
  {
      // cdaller: this is copied from the source of batik (xml.apache.org/batik)
