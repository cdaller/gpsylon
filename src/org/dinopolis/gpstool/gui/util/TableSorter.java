 ...
 * <p>
 * If automatic sorting on mouse click in header is needed, use the {@link
 * #addMouseListenerToHeaderInTable(JTable)} method. One click sorts ascending,
 * the next descending.
 *
 * @version 1.5 12/17/97
 * @author Philip Milne
 * @author Christof Dallermassl (minor changes)
 */
...
public class TableSorter extends TableMap
{
	...
	public TableSorter()
	{
		sorted_indices_ = new int[0]; // for consistency
	}
