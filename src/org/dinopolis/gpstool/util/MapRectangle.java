...
{
  LatLonPoint position_;
  Dimension dimension_;
  float scale_;
  

  public MapRectangle(double latitude, double longitude, int width, int height, float scale)
  {
    position_ = new LatLonPoint(latitude,longitude);
...
//----------------------------------------------------------------------
/**
 * Get the latitude of the center postition.
 *
 * @return the latitude of the center position.
 */
...
//----------------------------------------------------------------------
/**
 * Get the longitude of the center postition.
 *
 * @return the longitude of the center position.
 */
