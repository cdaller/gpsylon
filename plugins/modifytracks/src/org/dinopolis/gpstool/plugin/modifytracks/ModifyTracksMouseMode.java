...
// ----------------------------------------------------------------------
/**
 * The mouse mode for the modify tracks plugin allows to interactively change tracks as remove
 * points add new points change old points by using the mouse.
 * 
...
public class ModifyTracksMouseMode implements MouseMode
{
  ...
  public static final String KEY_MODIFYTRACKS_MOUSEMODE_NAME = "modifytracks.mousemode.name";
  public static final String KEY_MODIFYTRACKS_MOUSEMODE_DESCRIPTION = "modifytracks.mousemode.description";
  public static final String KEY_MODIFYTRACKS_MOUSEMODE_MNEMONIC = "modifytracks.mousemode.mnemonic";
  public static final String KEY_MODIFYTRACKS_MOUSEMODE_ACCELERATOR_KEY = "modifytracks.mousemode.accelerator_key";
  public static final String KEY_MODIFYTRACKS_MOUSEMODE_ICON = "modifytracks.mousemode.icon";
   ...
   */
  public void initialize(Resources plugin_resources, ModifyTracksLayer layer, ModifyTracksPlugin plugin)
  {
  ...
  // ----------------------------------------------------------------------
  /**
   * Called by the application to switch the mouse mode on or off. If the mouse mode is switched
   * off, it must not react on mouse events (although it might register them). This method may be
   * used to change the mouse cursor, ...
   * 
   * @param active if <code>true</code> the mouse mode is switched on and should react on mouse
   *          events.
   */
   ...
   * 
   * @return <code>true</code> if the mouse mode is active and reacts on mouse events.
   */
  ...
  // ----------------------------------------------------------------------
  /**
   * The name returned here is used in the menu and/or the toolbar of the application to switch the
   * mouse mode on or off. It should be localized.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * The description returned here is used in the menu and/or the toolbar of the application to
   * switch the mouse mode on or off.
   * 
  ...
  // ----------------------------------------------------------------------
  /**
   * The icon returned here is used in the menu and/or the toolbar of the application to switch the
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns the mnemonic character that is used for manual (keyboard) selection in a menu. If
   * possible, it should be the first letter of the name (default).
   * 
   * @return a string describing the mnemonic character for this mouse mode when used in a menu.
   */
  ...
  // ----------------------------------------------------------------------
  /**
   * Returns the accelerator key that is used for the mouse mode in the menu or toolbar. The format
   * of the key strings is described in {@link javax.swing.KeyStroke#getKeyStroke(java.lang.String)}.
   * Some examples are given: <code>INSERT</code>,<code>controle
