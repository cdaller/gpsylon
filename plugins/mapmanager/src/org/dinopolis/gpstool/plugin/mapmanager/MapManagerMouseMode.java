...
public class MapManagerMouseMode implements MouseMode
{
	...
	public static final String KEY_MAPAMANGER_MOUSEMODE_NAME =
		"mapmanager.mousemode.name";
	public static final String KEY_MAPAMANGER_MOUSEMODE_DESCRIPTION =
		"mapmanager.mousemode.description";
	public static final String KEY_MAPAMANGER_MOUSEMODE_MNEMONIC =
		"mapmanager.mousemode.mnemonic";
	public static final String KEY_MAPAMANGER_MOUSEMODE_ACCELERATOR_KEY =
		"mapmanager.mousemode.accelerator_key";
	public static final String KEY_MAPAMANGER_MOUSEMODE_ICON =
		"mapmanager.mousemode.icon";
	...
	public void initialize(
		...
		MapManagerLayer layer,
		MapManagerPlugin plugin,
    ...
    if(!mode_active_)
      return;
		...
		if(event.isControlDown())
			plugin_.addMapSelection(map_infos);
		else
			plugin_.setMapSelection(map_infos);
	}
