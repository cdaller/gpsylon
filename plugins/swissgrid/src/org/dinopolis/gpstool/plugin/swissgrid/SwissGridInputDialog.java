...
public class SwissGridInputDialog extends JDialog implements GpsylonKeyConstants
{
 ...
 */
  ...
  public SwissGridInputDialog(Resources resources, ActionListener action_listener, Frame owner)
  {
    super(owner,false);
