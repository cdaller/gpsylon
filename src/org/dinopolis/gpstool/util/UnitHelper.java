...
public class UnitHelper  
{
  ...
  public final static double KM2MILES  = 0.62137119;
  public final static double KM2NAUTIC = 0.54;
  public final static double METER2FEET = 3.280839895;
 ...
 * the allowed values.
 */
  public UnitHelper(int unit_system)
 ...
 * the allowed values.
 */
  public void setUnitSystem(int unit_system)
    throws IllegalArgumentException
  {
    if((unit_system < 1) || (unit_system > 3))
      throw new IllegalArgumentException("Unit System must be one of 'UNIT_SYSTEM_METRIC','UNIT_SYSTEM_MILES', or 'UNIT_SYSTEM_NAUTIC'");
