...
//----------------------------------------------------------------------
/**
 * The SwissGrid MouseMode
 * 
 * @author Samuel Benz
 * @version $Revision$
 */

public class SwissGridMouseMode implements MouseMode, AWTEventListener
{
	boolean mode_active_ = true;
	Resources resources_;
	SwissGridLayer layer_;
	MapManagerHook map_manager_;
	JLabel statusMsg_;
	SwissGridPlugin plugin_;

	public static final String KEY_SWISSGRID_MOUSEMODE_NAME =
		"swissgrid.mousemode.name";
	public static final String KEY_SWISSGRID_MOUSEMODE_DESCRIPTION =
		"swissgrid.mousemode.description";
	public static final String KEY_SWISSGRID_MOUSEMODE_MNEMONIC =
		"swissgrid.mousemode.mnemonic";
	public static final String KEY_SWISSGRID_MOUSEMODE_ACCELERATOR_KEY =
		"swissgrid.mousemode.accelerator_key";
	public static final String KEY_SWISSGRID_MOUSEMODE_ICON =
		"swissgrid.mousemode.icon";
	...
	public void initialize(
		...
		SwissGridLayer layer,
		SwissGridPlugin plugin,
...
//	----------------------------------------------------------------------
	...
	{
		//		return(resources_.getIcon(KEY_SWISSGRID_MOUSEMODE_ICON));
		return (null);
	}
	...
	public void mouseMoved(MouseEvent event)
	{
	    if(!mode_active_)
	        return;
	  		...
	  		Point2D swiss = SwissProjection.ll2lv03(wgs84.getLatitude(),wgs84.getLongitude());
	  		int m25 = SwissProjection.lv03tosn(swiss,25);
	  		int m50 = SwissProjection.lv03tosn(swiss,50);
	  		int m100 = SwissProjection.lv03tosn(swiss,100);
	  		...
	  		//System.out.println(" " + wgs84.getLatitude() + "/" + wgs84.getLongitude() + " " + (int) swiss.getX() + "/" + (int) swiss.getY());
