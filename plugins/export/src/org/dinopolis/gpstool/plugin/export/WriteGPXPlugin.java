...
public class WriteGPXPlugin extends AbstractTemplateExportPlugin implements GpsylonKeyConstants
{



      // resource keys:
  private static final String KEY_WRITEGPX_PLUGIN_IDENTIFIER = "export.gpx.plugin.identifier";
  private static final String KEY_WRITEGPX_PLUGIN_VERSION = "export.gpx.plugin.version";
  private static final String KEY_WRITEGPX_PLUGIN_NAME = "export.gpx.plugin.name";
  private static final String KEY_WRITEGPX_PLUGIN_DESCRIPTION = "export.gpx.plugin.description";
  private static final String KEY_WRITEGPX_FILE_EXTENSION  = "export.gpx.file.extension";
  private static final String KEY_WRITEGPX_FILE_DESCRIPTIVE_NAME  = "export.gpx.file.descriptive_name";

  static final String KEY_WRITEGPX_TEMPLATE  = "export.gpx.template";

  /**
   * Default Constructor
   */
  public WriteGPXPlugin()
  {
    super();
  }
  ...
  protected URL getTemplateUrl() {
    String template = getResources().getString(KEY_WRITEGPX_TEMPLATE);
 ...
 */
  ...
  {
    return(getResources().getString(KEY_WRITEGPX_FILE_DESCRIPTIVE_NAME));
  }
 ...
 */
  ...
  {
    return(getResources().getStringArray(KEY_WRITEGPX_FILE_EXTENSION));
  }
 ...
 */
  ...
  {
    return(getResources().getString(KEY_WRITEGPX_PLUGIN_IDENTIFIER));
  }
 ...
 */
  ...
  {
    return((float)getResources().getDouble(KEY_WRITEGPX_PLUGIN_VERSION));
  }
 ...
 */
  ...
  {
    return(getResources().getString(KEY_WRITEGPX_PLUGIN_NAME));
  }
 ...
 */
  ...
  {
    return(getResources().getString(KEY_WRITEGPX_PLUGIN_DESCRIPTION));
  }
